/*
  ...
  - You are about to drop the column `dueMonth` on the `Task` table. All the data in the column will be lost.
  - You are about to drop the column `dueyear` on the `Task` table. All the data in the column will be lost.
  - You are about to drop the column `dueMonth` on the `subTask` table. All the data in the column will be lost.
  - You are about to drop the column `dueyear` on the `subTask` table. All the data in the column will be lost.
